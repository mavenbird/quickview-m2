...
define([
    ...
    $.widget('mavenbird.mavenbird_beforebodyend', {
        _create: function () {
            ...
            $(document).ready(function() {
                ...
                $(document).on('click','a', function(e){
                    ...
                    if ($(this).attr('data-post')) {
                        ...
                        url = data_url.action + 'product/' + data_url.data.product + '/qty/'+ qty+ '/form_key/'+ from_key + '/uenc/' + data_url.data.uenc + '/mavenbirdquickview/1';
                    }else{
                        url = $(this).attr('href');
                        var myClass = $(this).attr('class');
                    }
                    if (showMoreInfo == 1 && showReview == 1) {
                        if (url != '#additional' && url != '#reviews' && url != '#product.info.description' && url != '#description'  && myClass != 'action add' && myClass != 'action view') {
    ...
    return $.mavenbird.mavenbird_beforebodyend;
});
